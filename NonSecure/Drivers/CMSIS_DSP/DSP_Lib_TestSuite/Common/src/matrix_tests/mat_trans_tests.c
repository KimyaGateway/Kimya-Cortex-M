#include "../../../../../CMSIS_DSP/DSP_Lib_TestSuite/Common/inc/matrix_tests/matrix_templates.h"
#include "../../../../../CMSIS_DSP/DSP_Lib_TestSuite/Common/inc/matrix_tests/matrix_test_data.h"
