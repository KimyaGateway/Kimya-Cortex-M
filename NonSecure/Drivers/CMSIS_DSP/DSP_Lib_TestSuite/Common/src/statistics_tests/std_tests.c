#include "../../../../../CMSIS_DSP/DSP_Lib_TestSuite/Common/inc/statistics_tests/statistics_templates.h"
#include "../../../../../CMSIS_DSP/DSP_Lib_TestSuite/Common/inc/statistics_tests/statistics_test_data.h"
