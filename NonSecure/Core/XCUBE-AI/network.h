...
#define AI_NETWORK_ORIGIN_MODEL_NAME   "model_20211008t143126"
...
#define AI_NETWORK_IN { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 15, 13, 1, 1, NULL), \
}
...
#define AI_NETWORK_IN_1_HEIGHT      (15)
#define AI_NETWORK_IN_1_WIDTH       (13)
#define AI_NETWORK_IN_1_CHANNEL     (1)
#define AI_NETWORK_IN_1_SIZE        (15 *  13 *  1)
